...
class DatasetDialog(QtFramelessTool):
    ...
    def on_filter_by_reader_type(self, filters: list[str]) -> None:
        """Filter by reader type."""
        self._list.on_filter_by_reader_type(filters)

    def on_filter_by_dataset_name(self, filters: list[str]) -> None:
        """Filter by dataset name."""
        print(filters)

    def on_filter_by_channel_name(self, filters: list[str]) -> None:
