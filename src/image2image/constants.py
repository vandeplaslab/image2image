...
UINT8_WARNING = (
    ...
    " loss and should be used with caution. If you are exporting RGB images (e.g. H&E or PAS), then this is not"
    " a concert since that data is already in the 0-255 range. However, if you are exporting images with a"
